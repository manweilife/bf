...
func (s Signature) MarshalJSON() ([]byte, error) {
	switch {
	case s.Ed25519BfcSignature != nil:
		return json.Marshal(s.Ed25519BfcSignature.Signature[:])
	case s.Secp256k1BfcSignature != nil:
		return json.Marshal(s.Secp256k1BfcSignature.Signature[:])
	case s.Secp256r1BfcSignature != nil:
		return json.Marshal(s.Secp256r1BfcSignature.Signature[:])
	default:
...
func (s *Signature) UnmarshalJSON(data []byte) error {
	...
	case 0:
		...
		s.Ed25519BfcSignature = &Ed25519BfcSignature{
...
func (s *BfcKeyPair) Sign(msg []byte) Signature {
	...
	case 0:
		return Signature{
			Ed25519BfcSignature: NewEd25519BfcSignature(s.Ed25519, msg),
		}
	default:
		return Signature{}
	}
